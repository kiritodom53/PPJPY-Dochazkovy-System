...
class Example(Frame):
    def __init__(self,
        ...
        self.odchozeno: str = "Odchozeno:"
        self.nastup: str = "Nástup: " + hire_date
        self.userLogIn: str = "Přihlášen: " + usr
        self.__init_ui()
        self.btnUpdateEvent()
    ...
    def btnUpdateEvent(self):
        ...
        for x in p_rows:
            ...
            if (x[2] is None):
                ...
                vstup += " >  " + str(helper.Validation.number_of_hours(x[2], x[1]))
    ...
    def __init_ui(self):
        ...
        if (self.isEmployer):
            btnHire = Button(self, text="Hire", command=self.hire_form)
            btnHire.grid(row=3, column=3, pady=4, sticky=E, padx="4")
        else:
            btnChangePassword = Button(self, text="Změnit heslo", command=self.change_password_form)
